...
namespace KerbinHeavyIndustries {
	using Toolbar;
	...
	public class ELAppButton : MonoBehaviour
	{
		...
		void OnGUIAppLauncherReady ()
		{
			if (ApplicationLauncher.Ready && button == null) {
				var tex = GameDatabase.Instance.GetTexture("KerbinHeavyIndustries/Textures/icon_button", false);
	...
	public class ELToolbar_ShipInfo : MonoBehaviour
	{
		...
		public void Awake ()
		{
			...
			ELEditorButton = ToolbarManager.Instance.add ("KerbinHeavyIndustries", "ELEditorButton");
			ELEditorButton.Visible = ELSettings.PreferBlizzy;
			ELEditorButton.TexturePath = "KerbinHeavyIndustries/Textures/icon_button";
	...
	public class ELToolbar_BuildWindow : MonoBehaviour
	{
		...
		public void Awake ()
		{
			...
			ELBuildWindowButton = ToolbarManager.Instance.add ("KerbinHeavyIndustries", "ELBuildWindowButton");
			ELBuildWindowButton.Visible = ELSettings.PreferBlizzy;
			ELBuildWindowButton.TexturePath = "KerbinHeavyIndustries/Textures/icon_button";
	...
	public class ELToolbar_SettingsWindow : MonoBehaviour
	{
		...
		public void Awake ()
		{
			...
			ELSettingsButton = ToolbarManager.Instance.add ("KerbinHeavyIndustries", "ELSettingsButton");
			ELSettingsButton.Visible = ELSettings.PreferBlizzy;
			ELSettingsButton.TexturePath = "KerbinHeavyIndustries/Textures/icon_button";
